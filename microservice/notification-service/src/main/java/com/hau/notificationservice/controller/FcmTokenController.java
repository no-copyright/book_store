...
public class FcmTokenController {
    ...
    @PostMapping
    public ResponseEntity<ApiResponse<FcmTokenResponse>> fcmTokenResponse(
            @RequestBody FcmTokenCreateRequest fcmTokenCreateRequest) {
        ApiResponse<FcmTokenResponse> fcmTokenResponse =
                fcmTokenService.fcmTokenResponseApiResponse(fcmTokenCreateRequest);
